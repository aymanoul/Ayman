...
import { Wortanatomie, WurzelThread, PluralHoheit } from '../../components/exhibits/HoheliedExhibits'
  ...
  return (
    <main className="shell seal">
      <div className="wrap">
        ...
        {/* ---- the word (centrepiece) ---- */}
        <section className="sec">
          <Eyebrow kicker="Haupt-Exhibit" title="Ein Wort, fast ein Name" />
          <p className="sec__lead">
            Das Wort, das die Lobrede der Braut krönt, zerlegt in seine Bausteine — und im Kern vier Buchstaben,
            die den Namen tragen.
          </p>
          <Wortanatomie />
        </section>
        ...
        {/* ---- the root thread ---- */}
        <section className="sec">
          <Eyebrow kicker="Der rote Faden" title="Dieselbe Wurzel, immer wieder" />
          <WurzelThread />
        </section>

        {/* ---- the belege showcase — ALL of them ---- */}
        <section className="sec">
          <Eyebrow kicker="Die Belege" title="Wurzel, Name und Lied" />
          <p className="sec__lead">
          ...
          <div className="belege-grid">
            ...
            <BelegCard beleg={hoheliedBelege.dan923} />
            <BelegCard beleg={hoheliedBelege.hag27} />
            <BelegCard beleg={hoheliedBelege.q4829} />
            <BelegCard beleg={hoheliedBelege.q3144} />
